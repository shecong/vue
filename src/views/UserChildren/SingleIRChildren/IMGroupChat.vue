  ...
  <div class="chat-container">
            ...
            <div class="message-item-content" :class="{ self: message.senderId === currentUser.id }">
              ...
              <div class="message-content" @click.right="showActionPopup(message)">
                <div class="message-payload">
                  ...
                  <goeasy-video-player v-if="message.type === 'video'" :thumbnail="message.payload.thumbnail"
    ...
    <div class="chat-footer">
      ...
      <div class="action-box" v-else>
        <div class="action-bar">
          ...
          <div class="action-item">
            <div v-if="emoji.visible" class="emoji-box">
              <img v-for="(emojiItem, emojiKey, index) in emoji.map" class="emoji-item" :key="index"
        ...
        <div class="input-box">
          <textarea ref="input" @focus="onInputFocus" @keyup.enter="sendTextMessage" v-model="text" maxlength="700"
...
import GoeasyVideoPlayer from "../../../components/User/SingleIRChildren/GoEasyVideoPlayer";
...
export default {
  ...
  created() {
    ...
    this.goEasyIM.im.on(this.GoEasy.IM_EVENT.GROUP_MESSAGE_RECEIVED, this.onReceivedGroupMessage);
  },
  beforeDestroy() {
    this.goEasyIM.im.off(this.GoEasy.IM_EVENT.GROUP_MESSAGE_RECEIVED, this.onReceivedGroupMessage);
  },
  methods: {
    formatDate,
